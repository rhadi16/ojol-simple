<?php 
  ...
  $qry = "SELECT
            *
          FROM driver WHERE id_driver = $driver";
?>
      ...
      <?php
        ...
        ?>
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-warning mb-1" data-bs-toggle="modal" data-bs-target="#edit-profile<?php echo $data['id_driver']; ?>">Edit</button>
            </td>
          </tr>

          <!-- Modal Edit Profile -->
          <div class="modal fade" id="edit-profile<?php echo $data['id_driver']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <form action="func/profile_func.php?action=update" enctype="multipart/form-data" method="post">
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" name="nama_driver" required placeholder="Nama" value="<?php echo $data['nama_driver'] ?>">
                    </div>
                    <div class="mb-3">
