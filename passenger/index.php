<?php 
  ...
  if(isset($_SESSION['id_passenger'])){
    ...
    echo '<script language="javascript"> window.location.href = "dash_passenger" </script>';
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <script src="dash_passenger/assets/sweetalert/dist/sweetalert2.all.min.js"></script>
  <!-- My Script -->
