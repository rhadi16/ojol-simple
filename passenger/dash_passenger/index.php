<?php 
  ...
  if(!isset($_SESSION['id_passenger'])){
...
<body>
  ...
  <div class="side-navbar active-nav d-flex justify-content-between flex-wrap flex-column" id="sidebar">
    <ul class="nav nav-tabs flex-column text-white w-100" id="myTab" role="tablist">
      <a class="nav-link h6 text-white my-2 title-sidenav">
        ...
        <?php 
          $ad = mysqli_query($mysqli, "SELECT * FROM passenger WHERE id_passenger = '".$_SESSION['id_passenger']."'");
          $ad1 = mysqli_fetch_array($ad);
        ?>
        <h5><?php echo $ad1['nama_passenger']; ?></h5>
        <h5>. . . . . . . . . . . . . . . .</h5>
      </a>
      ...
      <li class="nav-item" role="presentation">
        <a class="nav-link text-white" id="order-tab" data-bs-toggle="tab" data-bs-target="#order" role="tab" aria-controls="order" aria-selected="true">
          <i class="bx bx-book-open"></i>
          <span class="li-sidenav">Order</span>
        </a>
      </li>
    </ul>
  ...
  ?>
      ...
      <?php } elseif ($desc == "suc-in-ord") { ?>
        <div class="desc-in" data-flashdata="<?php echo $desc; ?>"></div>
      <?php } elseif ($desc == "suc-ed-ord") { ?>
        <div class="desc-in" data-flashdata="<?php echo $desc; ?>"></div>
      <?php } elseif ($desc == "suc-del-ord") { ?>
        <div class="desc-in" data-flashdata="<?php echo $desc; ?>"></div>
      <?php } ?>
  <?php
    }
